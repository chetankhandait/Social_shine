...
const testimonials = [
  ...
  {
    image: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80",
      ...
      <div className="relative flex">
        ...
        <div className="container flex flex-col justify-center w-full h-full px-6 py-10 mx-auto lg:absolute lg:inset-x-0">
          ...
          <div className="mt-10 lg:mt-20 lg:flex lg:items-center">
            <img className="object-cover object-center w-full lg:w-[32rem] rounded-lg h-96" src={image} alt={name} />
