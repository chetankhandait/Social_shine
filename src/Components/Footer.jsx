...
const Footer = () => {
  return (
        ...
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    ...
                    <p class="max-w-sm mt-2  ">We’re a team of strategic creator and digital innovator, united focus in our pursuit of mastery and joyful.</p>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                ...
                <h1 class="max-w-lg text-xl font-semibold tracking-tight text-white xl:text-2xl dark:text-white">Subscribe   get update.</h1>

                <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row  ">
                    <input id="email" type="text" class="px-4 py-2 text-gray-700 bg-white  rounded-2xl dark:bg-white dark:text-gray-300        " placeholder="Email Address"
    ...
    <div class="container flex flex-col items-center justify-between px-6 py-8 mx-auto lg:flex-row">
        <a href="#">
            Copyright@SocialShine
        </a>

        <div class="flex flex-wrap items-center justify-center gap-4 mt-6 lg:gap-12 lg:mt-0">
            <a href="#" class="text-sm text-gray-600 transition-colors duration-300 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 flex items-start flex-col font-medium ">
              Contact Us
              <span>
                +91 34343434343
              </span>
            ...
            <a href="#" class="text-sm text-gray-600 transition-colors duration-300 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 flex flex-col items-start font-medium">
               About 
               <span>
